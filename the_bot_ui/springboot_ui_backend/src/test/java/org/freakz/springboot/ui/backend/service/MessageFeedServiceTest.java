...
public class MessageFeedServiceTest {
    ...
    public void testGetMessagesForDay() {
        ...
        List<Message> forDay1 = sut.getMessagesForDay(LocalDateTime.of(2022, 10, 10, 11, 11, 0).toLocalDate());
        List<Message> forDay2 = sut.getMessagesForDay(LocalDateTime.of(2022, 10, 11, 13, 13, 0).toLocalDate());
