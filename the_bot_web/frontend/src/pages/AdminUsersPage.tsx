...
const permissionLabels: Record<string, string> = {
  ...
  'channels.view.all': 'View all channels',
  'channels.send.all': 'Send to all channels',
  'channels.view.irc': 'View IRC channels',
  'channels.send.irc': 'Send to IRC channels',
  'channels.view.discord': 'View Discord channels',
  'channels.send.discord': 'Send to Discord channels',
  'channels.view.telegram': 'View Telegram channels',
  'channels.send.telegram': 'Send to Telegram channels',
  'channels.view.whatsapp': 'View WhatsApp channels',
  'channels.send.whatsapp': 'Send to WhatsApp channels',
