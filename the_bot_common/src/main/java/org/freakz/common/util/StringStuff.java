...
public class StringStuff {
  ...
  public static final SimpleDateFormat STRING_STUFF_DF_DDMMHHMM =
      new SimpleDateFormat("dd.MM. HH:mm");
  public static final SimpleDateFormat STRING_STUFF_DF_DDMMYYYYHHMM =
      new SimpleDateFormat("dd.MM.yyyy HH:mm");
  public static final SimpleDateFormat STRING_STUFF_DF_DDMMYYYY =
  ...
  public static String fillTemplate(String template, Object[] values, String[] format) {
  ...
  /**
   * Common date parsing method to be used to convert String to the date. This currently expects the
  ...
  public static String htmlEntityDecode(String s) {
    ...
    else sb.append(s.substring(pos, s.length()));
    return sb.toString();
  }
   ...
   * by the
   *
   * <p>XML 1.0 standard. For reference, please see the
   *
   * <p>standard. This method will return an empty String if the input is null or empty. Author
   * Donoiu Cristian, GPL
   *
