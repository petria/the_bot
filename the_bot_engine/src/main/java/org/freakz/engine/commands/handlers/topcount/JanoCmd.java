...
public class JanoCmd extends AbstractCmd {
  ...
  private static final Logger log = LoggerFactory.getLogger(JanoCmd.class);
  ...
  public String executeCommand(EngineRequest request, JSAPResult results) {
    ...
    GetDataValuesServiceResponse serviceResponse =
        doServiceRequest(request, results, ServiceRequestType.GetDataValuesService);
