...
public class ConversationsService {
  ...
  private void processConversation(
      BotEngine botEngine, EngineRequest request, Conversation conversation) {
  ...
  public Conversation createConversation(EngineRequest request, ConversationType type) {
    ...
    switch (type) {
      ...
      case QUIZ:
        ...
        Quiz.QuizQuestion question = Quiz.QuizQuestion.builder().question("Turku").build();
        ...
        step.getQuestionMap()
            .put("1", Quiz.QuizQuestion.builder().question("Turku").isCorrect(false).build());
        step.getQuestionMap()
            .put("2", Quiz.QuizQuestion.builder().question("Hyvinkää").isCorrect(false).build());
        step.getQuestionMap()
            .put("3", Quiz.QuizQuestion.builder().question("Helsinki").isCorrect(true).build());
        step.getQuestionMap()
            .put("4", Quiz.QuizQuestion.builder().question("Oulu").isCorrect(false).build());
        ...
        step.getQuestionMap()
            .put("1", Quiz.QuizQuestion.builder().question("Wheeny").isCorrect(false).build());
        step.getQuestionMap()
            .put("2", Quiz.QuizQuestion.builder().question("Pheeny").isCorrect(false).build());
        step.getQuestionMap()
            .put("3", Quiz.QuizQuestion.builder().question("Eeny").isCorrect(true).build());
        step.getQuestionMap()
            .put("4", Quiz.QuizQuestion.builder().question("Dont know").isCorrect(false).build());
